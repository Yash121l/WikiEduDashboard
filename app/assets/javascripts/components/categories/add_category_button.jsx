  ...
  if (permitted) {
    ...
    editRow = (
      <tr className="edit">
        <td>
          <form
            onSubmit={handleAddCategory} style={{
            display: 'flex',
            flexDirection: 'column',
            gap: '1em'
          }}
...
AddCategoryButton.propTypes = {
  ...
  addCategory: PropTypes.func,
  source: PropTypes.string.isRequired,
  scopingMethods: PropTypes.object.isRequired,
  resetScopingMethod: PropTypes.func.isRequired
};
